...
class DemoWindow < Gosu::Window
  ...
  def draw
    ...
    @frames += 1
    @font.draw("Time: %2d:%02d:%02d fps: %d" % [hour, minute, second, @last_frames], 10, 10, ZOrder::UI, 1.0, 1.0, 0xffffff00)
    ...
    60.times do |min|
      ...
      draw_line x1, y1, @face_color, x2, y2, @face_color, ZOrder::ClockFace
    end
    ...
    draw_line @center_x, @center_y, @second_color, second_x, second_y, @second_color, ZOrder::ClockHands
    draw_line @center_x, @center_y, @minute_color, minute_x, minute_y, @minute_color, ZOrder::ClockHands
    draw_line @center_x, @center_y, @hour_color, hour_x, hour_y, @hour_color, ZOrder::ClockHands
